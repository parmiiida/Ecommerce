  ...
  return (
    <div className='product-container'>
              ...
              <div className='flex gap-3'>
                ...
                <div className='product-reviews'>
                  <Image
                    ...
                    <p className='font-semibold text-sm text-secondary'>{product.reviewsCount}</p>
                </div>
              </div>
      ...
      <div className='flex flex-col gap-16 '>
        ...
        <button className='btn w-fit mx-auto items-center justify-center gap-3 min-w-[200px] flex'>
          <Image
    ...
    {similarProducts && similarProducts?.length > 0 && (
      <div className='py-14 flex flex-col w-full gap-2'>
        <p className='sextion-text'> Similar Products</p>
